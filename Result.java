...
public static void main(String arg[])
{
    ...
    String name, cname,rollno;    inti, Gtotal=0,count=0;
 String subject[] = { "DM", "IOS", "OOPS","FDS","DAA","Interpersonal Skills"}; String subcode[]= { "DM-MA8351","IOS-D8301","OOPS-CS8392","FDS-AD8302","DAA-AD8351","IS-HS8381"};
intmidmarks[]= new int[6];
intsemmarks[]= new int[6];
